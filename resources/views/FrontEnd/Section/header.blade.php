		                    ...
		                    <div class="rgpd-content">
		                        ...
		                        <p>Si toutefois vous rencontrez des difficultés, vous pouvez aussi vous adresser au délégué à
		                            ...
		                            <a href="mailto:mesdonnees@mytroc.fr"
		                                class="rgpd-link">informatique-et-libertes@mytroc.fr</a></p>
		                    ...
		                    <div class="max-container">
		                        <div class="scrollable">
		                            ...
		                            <div>
		                                ...
		                                <p class="hpad"><b>Vous avez cependant la possibilité de <label for="cookie-analytics"
		                                            class="rgpd-link">désactiver le suivi de mesure d'audience</label> </b>
		                                </p>
