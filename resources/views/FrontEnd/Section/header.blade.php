...
<HEAD>
	...
	<script type="text/javascript" charset="UTF-8" src="../www.google.com/recaptcha/api9673.js?nocookie=true" async defer></script>
				...
				<div class="rgpd-popup-content">
					...
					<div class="rgpd-content">
						...
						<p>Ces données sont collectées pour gérer votre compte et vos échanges/achats. Vous pouvez
							consulter notre <a href="gestion-des-donnees-personelles.html" target="_blank" class="rgpd-link">charte de protection données personnelles et leur traitements</a>
						</p>
						...
						<p>Conformément à la réglementation en matière de données personnelles, vous disposez d'un
							...
							limitation que vous pouvez exercer par courrier électronique à l'adresse : <a href="mailto:mesdonnees@mytroc.fr" class="rgpd-link">mesdonnees@mytroc.fr</a> en
						...
						<p>Si toutefois vous rencontrez des difficultés, vous pouvez aussi vous adresser au délégué à
							...
							<a href="mailto:mesdonnees@mytroc.fr" class="rgpd-link">informatique-et-libertes@mytroc.fr</a>
						</p>
					...
					<div class="max-container">
						<div class="scrollable">
							...
							<div>
								...
								<p class="hpad"><b>Vous avez cependant la possibilité de <label for="cookie-analytics" class="rgpd-link">désactiver le suivi de mesure d'audience</label> </b>
								</p>
