<div class="col-xl">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <p><b>Status : </b> <span
                    class="badge @if ($claim->status == 'PENDING') bg-label-danger
            ...
            <div class="response-section">
                ...
                @foreach ($responses as $response)
                    <div class="response">
                        ...
                        <p><i class="bx bx-comment bx-tada"></i> {{ $response->content }} Le
                            <b>{{ $response->response_date }}</b></p>
                    </div>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" data-bs-toggle="modal"
                                data-bs-target="#editResponseModal_{{ $response->id }}">
                            ...
                            <form method="POST" id="delete-form"
                                action="{{ route('reply.destroy', ['id' => $response->id]) }}">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-icon me-2 btn-outline-danger"
                        ...
                        <!--------------------------------------------------------------------UPDATE------------------------------------------------->
                        <div class="modal fade" id="editResponseModal_{{ $response->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST"
                                            action="{{ route('responses.update', ['id' => $response->id]) }}">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <button type="submit" class="btn btn-primary">Mettre à jour la
                                                réponse</button>
                                        </form>
                                    </div>
                                </div>
