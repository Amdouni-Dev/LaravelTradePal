            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input name="name" type="text" id="basic-icon-default-company" class="form-control"
                            placeholder="Animaux sans toit.." aria-label="ACME Inc."
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input name="email" type="text" id="basic-icon-default-email" class="form-control"
                            ...
                            value="{{ $organization->email ?? old('email') }}" />
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input name="phone_number" type="text" id="basic-icon-default-phone"
                            class="form-control phone-mask" placeholder="99 999 999" aria-label="99 999 999"
                            aria-describedby="basic-icon-default-phone2"
                            value="{{ $organization->phone_number ?? old('phone_number') }}" />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-website" class="input-group-text"><i
                                class="bx bx-link-external"></i></span>
                        <input name="website" type="text" id="basic-icon-default-website" class="form-control"
                            placeholder="https://example.org/" aria-label="https://example.org/"
                            aria-describedby="basic-icon-default-website"
                            value="{{ $organization->website ?? old('website') }}" />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input name="location" type="text" id="basic-icon-default-address" class="form-control"
                            placeholder="18 rue l'artisanat, Ariana, 2073" aria-label="https://example.org/"
                            aria-describedby="basic-icon-default-location"
                            value="{{ $organization->location ?? old('location') }}" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input name="founding_date" type="date" id="basic-icon-default-phone"
                                class="form-control phone-mask" placeholder="https://example.org/"
                                aria-label="https://example.org/" aria-describedby="basic-icon-default-phone2"
                                value="{{ $organization->founding_date ?? old('founding_date') }}" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-phone2" class="input-group-text"><i
                                    class="bx bx-select-multiple"></i></span>
                            <select name="type" class="form-select" id="exampleFormControlSelect1"
                                aria-label="Default select example">
                                <option value="Education"
                                    {{ isset($organization) && $organization->type == 'Education' ? 'selected' : '' }}>
                                    Education</option>
                                <option value="Environnement"
                                    {{ isset($organization) && $organization->type == 'Environnement' ? 'selected' : '' }}>
                                    Environnement</option>
                                <option value="Santé"
                                    {{ isset($organization) && $organization->type == 'Santé' ? 'selected' : '' }}>
                                    Santé</option>
                                <option value="Protection des animaux"
                                    {{ isset($organization) && $organization->type == 'Protection des animaux' ? 'selected' : '' }}>
                                    Protection des animaux</option>
                                <option value="Droits de l'homme"
                                    {{ isset($organization) && $organization->type == "Droits de l'homme" ? 'selected' : '' }}>
