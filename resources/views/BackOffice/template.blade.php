...
<head>
    ...
    <link rel="stylesheet"
        href="/back/assets/vendor/libs/perfect-scrollbar/perfect-scrollbarc5ea.css?id=98fefe4424f0148a6e7c70b613511b33" />
        ...
        <div class="layout-container">
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template-free/demo"
                            ...
                            <div id="logo" class="waves waves-prune" data-wave-scale="20">
                                <a href="/">
                                    <table>
                                        <tr>
                                            <td>
                                                <img src="/image/logo/mytroc.svg" style="width:48px" alt="mytroc"
                                                    class="frame1 svg">
                                            </td>
                                            <td>
                                                <div class="title" data-fscale="1" style="font-size:30px">
                                                    Trade<strong>Pal</strong><span class="haf-caps"></span></div>
                                            </td>
                                        </tr>
                                    </table>
                                </a>
            ...
            <div class="layout-page">
                ...
                <script src="/back/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar7d0f.js?id=2f948c841c6aca9e3a18f6ef2c65b140">
                </script>
